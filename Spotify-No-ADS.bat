...
echo +++++++++++++++++++++++++++++++++++++++++++++++++
echo ----------------Spotify- NO ADS------------------
echo +        by Create Matheus Benites 2018         +
echo +++++++++++++++++++++++++++++++++++++++++++++++++
echo.
echo Por favor, Considere a opcao de pagar a taxa mensal premium da Spotify.
echo.
pause
...
cd..
Start Spotify.exe
msg * Desativado ADS com sucesso
exit
...
setlocal ENABLEDELAYEDEXPANSION & set "_FilePath=%~1"
  ...
  :_getElevation
  echo/Solicitando permissao de SuperUsuario
